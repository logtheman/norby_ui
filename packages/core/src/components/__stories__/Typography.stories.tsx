...
const TypographySection: React.FC<{ title: string; variants: string[] }> = ({
  title,
  variants
}) => (
...
export const AllVariants: Story = {
  render: () => (
    <div style={{ padding: '2rem', maxWidth: '1200px' }}>
      ...
      <TypographySection title="Titles" variants={['titleLarge', 'titleMedium']} />
      ...
      <TypographySection title="Labels" variants={['labelLarge', 'labelMedium', 'labelSmall']} />

      <TypographySection title="Links" variants={['linkLarge', 'linkMedium', 'linkSmall']} />
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', maxWidth: '600px' }}>
      <Typography variant="bodyLarge1">
        Body Large 1 - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography variant="bodyLarge2">
        Body Large 2 - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography variant="bodyMedium1">
        Body Medium 1 - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography variant="bodyMedium2">
        Body Medium 2 - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
      <Typography variant="bodyMedium3">
        Body Medium 3 - Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.
      </Typography>
    </div>
  )
