...
export const Default: S = {
  render: () => (
    <Tabs defaultSelectedKey="1">
      <Tab key="1" title="Tab 1">Content for Tab 1</Tab>
      <Tab key="2" title="Tab 2">Content for Tab 2</Tab>
      <Tab key="3" title="Tab 3">Content for Tab 3</Tab>
    </Tabs>
  )
};
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <Tabs color="primary" defaultSelectedKey="1">
        <Tab key="1" title="Primary">Content</Tab>
        <Tab key="2" title="Tab 2">Content</Tab>
      </Tabs>
      <Tabs color="secondary" defaultSelectedKey="1">
        <Tab key="1" title="Secondary">Content</Tab>
        <Tab key="2" title="Tab 2">Content</Tab>
      </Tabs>
      <Tabs color="success" defaultSelectedKey="1">
        <Tab key="1" title="Success">Content</Tab>
        <Tab key="2" title="Tab 2">Content</Tab>
      </Tabs>
    </div>
  )
